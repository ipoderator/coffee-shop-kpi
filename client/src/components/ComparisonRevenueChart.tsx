...
export function ComparisonRevenueChart({ 
      ...
      tooltip: {
        ...
        callbacks: {
          ...
          afterBody: function(context) {
            ...
            const currentValue = dayIndex < currentData.length ? currentData[dayIndex]?.revenue : null;
            const previousValue = dayIndex < previousData.length ? previousData[dayIndex]?.revenue : null;
  ...
  return (
    <Card className="relative p-6 shadow-lg border-border/50 overflow-hidden" data-testid="chart-comparison-revenue">
